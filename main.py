...
humidities = pd.read_csv("Humidity_level.csv", index_col=0, parse_dates=True)
temperatures = pd.read_csv("Temperature_change.csv", index_col=0, parse_dates=True)
soilmoistures = pd.read_csv("Soil_moisture_level.csv", index_col=0, parse_dates=True)
...
fig1.savefig("humidity.JPG"
fig2.savefig("temperature.JPG")
fig3.savefig("soilmoisture.JPG")
